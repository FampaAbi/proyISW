...
class Sala2 extends React.Component {
 ...
 <section className="text-center">
     <div className="container">
       <h1 style={{padding: "20px"}} className="jumbotron-heading">Sala B67</h1>
     </div>
 </section>
     ...
     <div className="container">
       <div className="row">
         <div className="col-md-4">
           <div className="card mb-4 shadow-sm">
             ...
             <div className="card-body">
               <p className="card-text">CAMA B67-2</p>
         ...
         <div className="col-md-4">
           <div className="card mb-4 shadow-sm">
             <svg className="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Servicio 2"><title>SALA DE RECUPERACION B67</title><rect width="100%" height="100%" fill="#21a900"/><text x="38%" y="50%" fill="#eceeef" dy=".3em">DISPONIBLE</text></svg>
             <div className="card-body">
               <p className="card-text">CAMA B67-3</p>
               <div className="d-flex justify-content-between align-items-center">
               <div className="btn-group">
                 <p><a href ="" role="button" className="btn btn-sm btn-outline-secondary">Ver paciente</a></p>
         ...
         <div className="col-md-4">
           <div className="card mb-4 shadow-sm">
             ...
             <div className="card-body">
               <p className="card-text">CAMA B67-4</p>
               <div className="d-flex justify-content-between align-items-center">
                 <div className="btn-group">
                   <p><a href ="" role="button" className="btn btn-sm btn-outline-secondary">Ver paciente</a></p>
         ...
         <div className="col-md-4">
           <div className="card mb-4 shadow-sm">
             <svg className="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Servicio 4"><title>Servicio 4</title><rect width="100%" height="100%" fill="#21a900"/><text x="38%" y="50%" fill="#eceeef" dy=".3em">DISPONIBLE</text></svg>
             <div className="card-body">
